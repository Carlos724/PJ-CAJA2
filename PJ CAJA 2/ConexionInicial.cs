    ...
    class ConexionInicial
    {
        ...
        public bool VerificarSesion()
        {
            ...
            try
            {
                ...
                string queryUltimoFolio = "SELECT Numero_Folio FROM operaciones WHERE Cajero = '"+ Properties.Settings.Default.strUsuario_ +"' AND Tipo_Operacion = 'folio' ORDER BY fecha_operacion DESC LIMIT 1;";
